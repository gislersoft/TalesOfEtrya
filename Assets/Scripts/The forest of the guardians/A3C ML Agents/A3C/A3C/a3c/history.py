...
history_keys = ['states', 'actions', 'rewards', 'action_probs', 'epsilons',
                'value_estimates', 'advantages', 'discounted_returns', 'target_value']

def discounted_rewards(r, gamma=0.99, value_next=0.0):
    """
...
def get_advantage(rewards, value_estimates, value_next=0.0, gamma=0.99, lambd=0.95):
    """
